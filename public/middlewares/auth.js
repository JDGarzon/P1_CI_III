...
exports.validateOrganizador = void 0;
...
const validateOrganizador = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let token = req.headers.authorization;
        if (!token) {
            return res.status(401).json({ message: "Not authorized" });
...
exports.validateOrganizador = validateOrganizador;
